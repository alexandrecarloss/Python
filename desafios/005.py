...
n = int(input(f'{cores["vermelho sublinhado"]}Digite um número inteiro: {cores["limpa"]}'))
print(f'O sucessor de {cores["azul sublinhado"]}{n}{cores["limpa"]} é {cores["verde em negrito"]}{n + 1}{cores["limpa"]} e o antecessor de {cores["azul sublinhado"]}{n}{cores["limpa"]} é {cores["ciano em negrito"]}{n - 1}{cores["limpa"]}')