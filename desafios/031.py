...
d = int(input(f'Qual a distância da su viagem viagem?{cores["azul sublinhado"]}'))
print(f'{cores["limpa"]}Você está prestes a começar uma viagem de {cores["azul sublinhado"]}{d}Km{cores["limpa"]}')
p = d * 0.5 if d <= 200 else d * 0.45
print(f'E o preço será de {cores["verde"]}R${p:.2f}{cores["limpa"]}')
'''if d <= 200:
    p = d * 0.5
