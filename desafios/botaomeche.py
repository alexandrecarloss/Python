...
text_id.pack()
button_1 = tk.Button(root, text='Não', bg='#ffb3c1', comand=denied, relief=RIDGE, bd=3, font=('Montserrat', 24, 'bold'))
button_1.pack()
root.bind('<Motion>', move_button_1)
button_2 = tk.Button(root, text='Sim', bg='#ff3c1', relief=RIDGE, bd=3, command=accepted, font=('Montserrat', 14, 'bold'))
button_2.pack()
