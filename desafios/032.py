...
ano = int(input(f'Qua ano quer analisar? Coloque {fundo["azul"]}0{cores["limpa"]} para analisar o ano atual.'))
if ano == 0:
    ano = date.today().year
if ano % 4 == 0 and ano % 100 != 0 or ano % 400 == 0:
    print(f'O ano {cores["azul"]}{ano} é BISSEXTO!{cores["limpa"]}')
else: 
    print(f'O ano {cores["vermelho"]}{ano} Não é BISSEXTO!{cores["limpa"]}')