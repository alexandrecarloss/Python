...
margin.pack()
text_id = Label(root, bg='#ffc8dd', text='Fototeta?', fg='#590d22', font=('Montserrat', 24, 'bold'))
text_id.pack()
button_1 = tk.Button(root, text='Não', bg='#ffb3c1', command=denied, relief=RIDGE, bd=3, font=('Montserrat', 24, 'bold'))
button_1.pack()
