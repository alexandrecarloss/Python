...
sal = float(input(f'Qual o salário atual? {cores["verde"]}R$'))
if sal > 1250:
    novo = sal * 1.1
else:
    novo = sal * 1.15
print(f'{cores["limpa"]}Para quem ganhava {cores["verde"]}R${sal:.2f}{cores["limpa"]} o salário com aumento será de {cores["azul"]}R${novo:.2f}{cores["limpa"]}')