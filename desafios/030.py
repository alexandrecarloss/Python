...
print('---PAR OU ÍMPAR!---')
n = int(input(f'Digite um número para saber se é par ou ímpar! '))
if (n % 2) == 0:
    print(f'O número {cores["verde"]}{n} é PAR!{cores["limpa"]}')
else: 
    print(f'O número {cores["vermelho"]}{n} é ÍMPAR{cores["limpa"]}')